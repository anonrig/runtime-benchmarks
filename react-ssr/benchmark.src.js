// React SSR benchmark - Uses React's renderToString
// Ported from: https://github.com/t3dotgg/cf-vs-vercel-bench/tree/main/react-ssr-bench
// Note: Requires react and react-dom packages. Uses browser version for edge compatibility.
...
function ComplexComponent() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      'Complex Server-Rendered Component (React SSR)'
    ),
...
export function handler() {
  const html = renderToString(React.createElement(ComplexComponent))
